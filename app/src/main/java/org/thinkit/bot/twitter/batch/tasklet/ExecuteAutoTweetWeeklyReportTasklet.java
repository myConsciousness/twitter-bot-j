...
@Component
public final class ExecuteAutoTweetWeeklyReportTasklet extends AbstractTasklet {

    /**
     * The constructor.
     */
    private ExecuteAutoTweetWeeklyReportTasklet() {
        super(TaskType.AUTO_TWEET_WEEKLY_REPORT);
    }

    /**
     * Returns the new instance of {@link ExecuteAutoTweetWeeklyReportTasklet} .
     *
     * @return The new instance of {@link ExecuteAutoTweetWeeklyReportTasklet}
     */
    public static Tasklet newInstance() {
        return new ExecuteAutoTweetWeeklyReportTasklet();
    }
    ...
    private UserProfileTransition getLatestUserProfileTransition(final UserProfile userProfile) {
        ...
        final UserProfileTransition userProfileTransition = userProfileTransitionRepository
                .findByUserIdAndUserProfileTransitionTypeCodeAndLatestTrue(userProfile.getUserId(),
                        UserProfileTransitionType.WEEKLY.getCode());
