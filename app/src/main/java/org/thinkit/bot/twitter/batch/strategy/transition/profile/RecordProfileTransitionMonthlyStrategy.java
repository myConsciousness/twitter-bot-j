...
public final class RecordProfileTransitionMonthlyStrategy extends AbstractRecordProfileTransitionStrategy {
     ...
     */
    private RecordProfileTransitionMonthlyStrategy(
    ...
    /**
     * Returns the new instance of {@link RecordProfileTransitionMonthlyStrategy}
     * based on the parameters passed as anh arguments.
     *
     * @param userProfileTransitionRepository The user profile transition repository
     * @param userProfile                     The user profile
     * @return The new instance of {@link RecordProfileTransitionMonthlyStrategy}
     *
     * @exception NullPointerException If {@code null} is passed as an argument.
     */
    public static Strategy<UserProfileTransition> from(
            @NonNull final UserProfileTransitionRepository userProfileTransitionRepository,
            @NonNull final UserProfile userProfile) {
        return new RecordProfileTransitionMonthlyStrategy(userProfileTransitionRepository, userProfile);
    }
