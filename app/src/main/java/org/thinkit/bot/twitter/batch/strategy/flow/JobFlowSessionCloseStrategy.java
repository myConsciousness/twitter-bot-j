...
public final class JobFlowSessionCloseStrategy implements Strategy<Job> {
    ...
    @Override
    public Job execute() {
        return this.jobBuilder.flow(this.batchStepCollections.getCloseSessionStep()).end().build();
    }
}
