...
public final class RecordProfileTransitionWeeklyStrategy extends AbstractRecordProfileTransitionStrategy {
     ...
     */
    private RecordProfileTransitionWeeklyStrategy(
    ...
    /**
     * Returns the new instance of {@link RecordProfileTransitionWeeklyStrategy}
     * based on the parameters passed as anh arguments.
     *
     * @param userProfileTransitionRepository The user profile transition repository
     * @param userProfile                     The user profile
     * @return The new instance of {@link RecordProfileTransitionWeeklyStrategy}
     *
     * @exception NullPointerException If {@code null} is passed as an argument.
     */
    public static Strategy<UserProfileTransition> from(
            @NonNull final UserProfileTransitionRepository userProfileTransitionRepository,
            @NonNull final UserProfile userProfile) {
        return new RecordProfileTransitionWeeklyStrategy(userProfileTransitionRepository, userProfile);
    }

    @Override
    public UserProfileTransition execute() {
        return DateUtils.isWeekend() ? super.recordTransition(UserProfileTransitionType.WEEKLY)
