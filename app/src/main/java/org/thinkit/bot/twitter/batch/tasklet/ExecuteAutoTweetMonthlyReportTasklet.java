...
@Component
public final class ExecuteAutoTweetMonthlyReportTasklet extends AbstractTasklet {

    /**
     * The constructor.
     */
    private ExecuteAutoTweetMonthlyReportTasklet() {
        super(TaskType.AUTO_TWEET_MONTHLY_REPORT);
    }

    /**
     * Returns the new instance of {@link ExecuteAutoTweetMonthlyReportTasklet} .
     *
     * @return The new instance of {@link ExecuteAutoTweetMonthlyReportTasklet}
     */
    public static Tasklet newInstance() {
        return new ExecuteAutoTweetMonthlyReportTasklet();
    }
    ...
    protected BatchTaskResult executeTask(StepContribution contribution, ChunkContext chunkContext) {
        ...
        for (final Language language : Language.values()) {
            final AutoTweetResult autoTweetResult = super.getTwitterBot()
                    .executeAutoTweet(Tweet.from(this.getWeeklyReport(language, userProfileDifference)));
    ...
    private UserProfileTransition getLatestUserProfileTransition(final UserProfile userProfile) {
        ...
        final UserProfileTransition userProfileTransition = userProfileTransitionRepository
                .findByUserIdAndUserProfileTransitionTypeCodeAndLatestTrue(userProfile.getUserId(),
                        UserProfileTransitionType.MONTHLY.getCode());
