...
public final class JobFlowTweetGreetingStrategy implements Strategy<Job> {
    ...
    @Override
    public Job execute() {
        return this.jobBuilder.flow(this.batchStepCollections.getExecuteAutoTweetGreetingStep()).end().build();
    }
}
